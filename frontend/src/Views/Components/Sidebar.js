...
function Sidebar(props) {
    ...
    return (
        ...
        <ul class="space-y-10 text-lg">
            {
                page==="dashboard"? 
                <li>
         <a href="/dashboard/" class="flex items-center bg-gray-200 space-x-3 text-red-500 p-2 rounded-md font-medium hover:bg-gray-200  focus:shadow-outline">
     ...
     
     {
         page==="profile"?
         <li>
         <a href="/adminprofile/" class="flex items-center space-x-3 bg-gray-200 text-red-500 p-2 rounded-md font-medium hover:bg-gray-200 focus:bg-gray-200 focus:shadow-outline">
             <span class="text-red-500">
                 <svg class="h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
     ...
     
     {
         page==="bookings"?
         <li>
         <a href="/bookings/" class="flex items-center space-x-3 bg-gray-200 text-red-500 p-2 rounded-md font-medium hover:bg-gray-200 focus:bg-gray-200 focus:shadow-outline">
             <span class="text-red-500">
       ...
       {
           page==="reports"? <li>
           <a href="/reports/" class="flex items-center space-x-3 bg-gray-200 text-red-500 p-2 rounded-md font-medium hover:bg-gray-200 focus:bg-gray-200 focus:shadow-outline">
               <span class="text-red-500">
               <svg xmlns="http://www.w3.org/2000/svg" class="h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
         ...
         <a href="/reports/" class="flex items-center space-x-3 text-gray-300 p-2 rounded-md font-medium hover:bg-gray-200 focus:bg-gray-200 focus:shadow-outline">
             <span class="text-gray-300">
             <svg xmlns="http://www.w3.org/2000/svg" class="h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
             </svg>
